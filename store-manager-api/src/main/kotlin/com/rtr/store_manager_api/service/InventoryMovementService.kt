...
interface InventoryMovementService {
    fun createMovement(dto: InventoryMovementRequestDTO, userId: String): InventoryMovementResponse
    fun getAllMovements(): List<InventoryMovementResponseDTO>
    fun getMovementById(id: String): InventoryMovementResponseDTO
    fun updateMovement(id: String, dto: InventoryMovementUpdateDTO, userId: String): InventoryMovementResponse
    fun deleteMovement(id: String, userId: String): InventoryMovementResponse
}